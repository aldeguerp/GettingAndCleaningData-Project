...
The final result it's saved in a file named export_data.txt

# Contents in this repository

* README.md: This file
* CodeBook.md: Descriptions
* run_analisys.R: R script which filter/adapt raw data
* export_data.txt: Final file after running the R script
